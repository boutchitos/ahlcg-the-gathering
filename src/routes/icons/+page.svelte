...
<div class="flex">
  <Guardian class="w-12 border" />
  <Mystic class="w-12 border" />
  <Rogue class="w-12 border" />
  <Seeker class="w-12 border" />
  <Survivor class="w-12 border" />
</div>
<div class="flex">
  <Guardian class="w-24 border" />
  <Mystic class="w-24 border" />
  <Rogue class="w-24 border" />
