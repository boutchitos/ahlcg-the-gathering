...
module.exports = {
  ...
  options: {
    ...
    */
    exclude: {
      path: '.*.test..*|.*index.ts|.*collection/edit/.*',
      //   dynamic: true
    },
    ...
    */
    focus: 'src/routes/collection|src/lib/userBrowsesItsCollection|src/gathering',
...
// generated: dependency-cruiser@16.0.0 on 2024-01-04T20:10:58.306Z
